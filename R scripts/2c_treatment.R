...
load("C:/Users/16083/Documents/GitHub/PaperEduc/Data 2015/lac_sample_data.RData")
...
save(schools, teachers, students, file = "lac_treatment_data.RData")
rm (list = ls(all.names = TRUE))
load("C:/Users/16083/Documents/GitHub/PaperEduc/Data 2015/lac_treatment_data.RData")
print("The Latin America and The Caribbean Sample has been Imported")