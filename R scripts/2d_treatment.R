...
load("C:/Users/16083/Documents/GitHub/PaperEduc/Data 2015/all_sample_data.RData")
...
##========================================================================##
lac_teachers = Teachers2
lac_students = Students2
lac_schools = Schools2
...
save(schools, teachers, students, file = "all_treatment_data.RData")
rm (list = ls(all.names = TRUE))
load("C:/Users/16083/Documents/GitHub/PaperEduc/Data 2015/all_treatment_data.RData")
print("The PISA 2015 (Teacher-Student-School-Mathc) Sample has been Imported")